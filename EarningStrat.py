# file for uploading daily stock data along with technical indicators using yfinance and TA
...
# Ensure data is in right format for calculating technical indicators
